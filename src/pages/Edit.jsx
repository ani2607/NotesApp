...
if(navigate){
  ...
  return (
    ...
    <div className="h-[410px] w-[550px]  m-auto mb-20 backdrop-blur-xl   mt-5   flex items-center flex-col text-white">
      ...
      <input type="text"className="mt-5 outline-none rounded  border border-teal-500/30  w-96 p-2" value={title} onChange={(e)=> setTitle(e.target.value)}  placeholder="Title..." />
